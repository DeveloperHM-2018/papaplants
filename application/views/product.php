                    ...
                    <ul class="shop-widget-list shop-widget-scroll">
                        <?php if (!empty($subcategory)) {
                            foreach ($subcategory as $row) {
                                $count = getNumRows('product', "JSON_SEARCH(`sub_category_id`,'all','" . $row['sub_category_id'] . "') IS NOT NULL");

                        ?>
                                <li>
                                    <div class="shop-widget-content">
                                        <input type="checkbox" class="common_selector subcategory" id="subcate<?= $row['sub_category_id'] ?>" value="<?php echo $row['sub_category_id']; ?>" <?= (($row['sub_category_id'] == $subcateid) ? 'Checked' : '')  ?>>
...
<script>
    $(document).ready(function() {
        ...
        function filter_data() {
            $('#filter_data').html('<div class="text-center" id="loading"><i class="fa fa-spin fa-spinner"></i></div>');
