                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control select2" multiple name="sub_category_id[]" data-placeholder="Select sub category" id="sub_category">
                                                    <?php
                                                    ...
                                                    ?>
                                                        <option value="<?= $c['sub_category_id'] ?>" <?= in_array($c['sub_category_id'], $sub_category_id) ? 'selected' : '' ?>><?= $c['sub_category_name'] ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        <div class="row">
                                            <label for="example-text-input" class="col-md-6 col-form-label">Product Type</label>
                                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="number" name="quantity" required value="<?= $quantity ? $quantity : 1 ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
