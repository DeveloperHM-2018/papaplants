                ...
                <div class="user-form-card">
                    ...
                    <div class="user-form-group">
                        ...
                        <form class="user-form" method="post" name="form_submit">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="postal_code" placeholder="Pincode*" value="<?= set_value('postal_code') ?>" maxlength="6" required>
                            </div>
                            <div class="form-group">
                                <select class="form-control" name="state" required id="state">
                                    ...
                                    ?>
                                            <option value="<?= $state['state_name'] ?>" <?= (($state['state_name'] ==  set_value('state')) ? 'Selected' : '') ?>><?= $state['state_name'] ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
