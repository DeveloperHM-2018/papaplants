...
<body>
	...
	<!-- page title area end  -->
	<!-- cart area start  -->
	<section class="h-100 h-custom" style="background-color: #f8f5f0;">
				...
				<div class="col-12">
					<div class="card card-registration card-registration-2" style="border-radius: 15px;">
						<div class="card-body p-0">
							<div class="row g-0">
								<div class="col-lg-8">
									<div class="p-5 padding-1">
										<div class="d-flex justify-content-between align-items-center mb-5">
											<h1 class="fw-bold mb-0 text-black smallfs">Shopping Cart</h1>
								...
								<div class="col-lg-4 bg-grey">
									<div class="p-5 padding-1">
										...
										<hr class="my-4 margin-1">
										<div class="d-flex justify-content-between margin-1 mb-4">
											<h5 class="text-uppercase">items </h5>
											<h5><span class="cart_count"></span></h5>
										</div>
										<hr class="my-4 margin-1">
										<div class="d-flex justify-content-between margin-1 mb-5">
